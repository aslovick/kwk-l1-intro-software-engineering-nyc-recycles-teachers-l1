...
def address(second_recycle_bin)
  second_recycle_bin["address"]
end 
...
def address(fourth_recycle_bin)
  fourth_recycle_bin["address"]
end 
...
def borough(third_recycle_bin)
  third_recycle_bin["borough"]
end 

def borough(fourth_recycle_bin)
  fourth_recycle_bin["borough"]
end 
...
def all_keys(second_recycle_bin)
  second_recycle_bin.each do |key, value|
    puts "#{key}"
  end
end 

def all_keys(third_recycle_bin)
  third_recycle_bin.each do |key, value|
    puts "#{key}"
  end
end 

def all_keys(fourth_recycle_bin)
  fourth_recycle_bin.each do |key, value|
    puts "#{key}"
  end
end 
...
def all_data(second_recycle_bin)
  second_recycle_bin.each do |key, value|
    puts "#{value}"
  end
end 

def all_data(third_recycle_bin)
  third_recycle_bin.each do |key, value|
    puts "#{value}"
  end
end 

def all_data(fourth_recycle_bin)
  fourth_recycle_bin.each do |key, value|
    puts "#{value}"
  end
end 
...
def key_and_data(second_recycle_bin)
  second_recycle_bin.each do |key, value|
    puts "The #{key} is #{value}"
  end
end 

def key_and_data(third_recycle_bin)
  third_recycle_bin.each do |key, value|
    puts "The #{key} is #{value}"
  end
end 

def key_and_data(fourth_recycle_bin)
  fourth_recycle_bin.each do |key, value|
    puts "The #{key} is #{value}"
  end
end 